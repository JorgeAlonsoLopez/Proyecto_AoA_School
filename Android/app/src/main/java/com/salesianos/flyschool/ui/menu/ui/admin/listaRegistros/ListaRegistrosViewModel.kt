...
class ListaRegistrosViewModel(application : Application) : AndroidViewModel(application) {
    ...
    private fun getRegistros() {
        service.listado("Bearer "+token).enqueue(object: Callback<List<DtoRegistro>> {
