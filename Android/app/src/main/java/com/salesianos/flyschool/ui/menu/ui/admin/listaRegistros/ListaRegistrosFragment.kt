...
import com.salesianos.flyschool.ui.menu.ui.admin.listaRegistros.dummy.DummyContent
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = ListaRegistrosRecyclerViewAdapter(DummyContent.ITEMS)
            }
        }
        return view
    }
